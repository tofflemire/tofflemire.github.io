...
The figure to the right presents our <i>UBVR</i> light curves from LCO and SMARTS. Typical of accretion, the amplitude of variability is larger in the blue (top) filters than the red. As with DQ Tau, we see persistent brightening events near periastron passages (dashed vertical lines). 
...
TWA 3A is one of the binaries in our sample for which we have overlapping time-series spectroscopy. You can learn more about that project <a href='https://tofflemire.github.io/spectroscopy/'>here</a>.
